...
class MyApp extends PolymerElement {
        ...
        <app-header-layout has-scrolling-region="">
          ...
          <app-header slot="header" condenses="" reveals="" effects="waterfall">
            <app-toolbar>
              ...
              <div main-title="">Nick's Todo Application</div>
            </app-toolbar>
          </app-header>

          <iron-pages selected="[[page]]" attr-for-selected="name" role="main">
            <todo-list-view name="todoListView" id="todoListView"></todo-list-view>
    ...
    _routePageChanged(page) {
        ...
        if (!page) {
            this.page = 'todoListView';
        } else if (['todoListView'].indexOf(page) !== -1) {
            this.page = page;
        } else {
            this.page = 'view404';
        }
